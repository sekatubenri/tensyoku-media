...
<div style="background:#fff7ed;border:2px solid #ea580c;border-radius:8px;padding:16px;margin:24px 0;">
  ...
  <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
    ...
    <li><a href="//af.moshimo.com/af/c/click?a_id=5718255&p_id=7382&pc_id=21253&pl_id=92850" rel="nofollow" referrerpolicy="no-referrer-when-downgrade" attributionsrc style="display:inline-block;background:#e11d48;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:bold;">▶ 内定ゼロ・出遅れでも諦めない！就活を立て直す個別サポート【キャリセン就活エージェント】無料相談</a><img src="//i.moshimo.com/af/i/impression?a_id=5718255&p_id=7382&pc_id=21253&pl_id=92850" width="1" height="1" style="border:none;" loading="lazy"></li>
  </ul>
</div>`;
